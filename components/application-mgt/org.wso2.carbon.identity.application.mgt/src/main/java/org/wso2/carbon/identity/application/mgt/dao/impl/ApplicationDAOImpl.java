...
public class ApplicationDAOImpl extends AbstractApplicationDAOImpl implements PaginatableFilterableApplicationDAO {
        ...
        if (CollectionUtils.isNotEmpty(propertyList)) {
            for (ServiceProviderProperty serviceProviderProperty : propertyList) {
                ...
                if (USE_DOMAIN_IN_ROLES.equals(name)) {
                    ...
                    localAndOutboundConfig.setUseExternalizedConsentPage(Boolean.parseBoolean(value));
                }
            }
        }
    }
    ...
    private ServiceProviderProperty buildUseExternalizedConsentPageProperty(ServiceProvider sp) {
        ...
        useExternalizedConsentPageProperty.setValue(
                String.valueOf(sp.getLocalAndOutBoundAuthenticationConfig().isUseExternalizedConsentPage()));
